...
public:
    [[nodiscard]] const Id& get_uid() const {
        return uid_;
    }

    void set_uid(const Id& uid) {
        uid_ = uid;
    }
    ...
    [[nodiscard]] const DateTime& get_dt_start() const {
        return dt_start_;
    }

    void set_dt_start(const DateTime& dt_start) {
        dt_start_ = dt_start;
    }

    [[nodiscard]] const DateTime& get_dt_end() const {
        return dt_end_;
    }

    void set_dt_end(const DateTime& dt_end) {
        dt_end_ = dt_end;
    }

    [[nodiscard]] const DateTime& get_dt_stamp() const {
        return dt_stamp_;
    }

    void set_dt_stamp(const DateTime& dt_stamp) {
        dt_stamp_ = dt_stamp;
    }
    ...
    void set_created(const DateTime& created) {
        created_ = created;
    }
    ...
    [[nodiscard]] const TimeZone& get_tz() const {
        return tz_;
    }

    void set_tz(const TimeZone& tz) {
        tz_ = tz;
    }

    [[nodiscard]] const Recurrence& get_rrule() const {
        return rrule_;
    }

    void set_rrule(const Recurrence& rrule) {
        rrule_ = rrule;
    }

    [[nodiscard]] uint8 get_recurrence_no() const {
        return recurrence_no_;
    }
    ...
    void set_rdate(const std::vector<DateTime>& rdate) {
        rdate_ = rdate;
    }
