...
// You may need to build the project (run Qt uic code generator) to get "ui_CategoryComboBox.h" resolved
...
namespace touka {
    ...
    void CategoryComboBox::addCategory(const EventCategories& category) {
        ...
        QRectF rect(borderWidth, borderWidth, size - 2 * borderWidth, size - 2 * borderWidth);
        ...
        painter.drawRoundedRect(rect.adjusted(-borderWidth/2, -borderWidth/2, borderWidth/4, borderWidth/4), radius, radius);
